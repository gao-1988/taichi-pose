...
def caluculate_cos(body_parts):
    # 1. left_shoulder-left_elbow-left_eye -> left_elbow-left_shoulder-left_ass
    ...
    cos_left_1 = cos_theta(body_parts['left_elbow'] - body_parts['left_shoulder'],
                           body_parts['left_ass'] - body_parts['left_shoulder'])
    ...
    cos_right_1 = cos_theta(body_parts['right_elbow'] - body_parts['right_shoulder'],
                            body_parts['right_ass'] - body_parts['right_shoulder'])
...
def draw_angles(img,body_parts):
    opencvwrite2(img, (0, 0, 255), body_parts['left_elbow'], body_parts['left_shoulder'], body_parts['left_ass'])
    ...
    opencvwrite2(img, (0, 0, 255), body_parts['right_elbow'], body_parts['right_shoulder'],
                 body_parts['right_ass'])
...
def draw_weights(img,body_parts):
